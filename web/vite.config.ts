...
export default defineConfig({
    // Electron 生产构建走 file:// 协议，资源需用相对路径；其他场景保持默认根路径
    base: process.env.ELECTRON ? "./" : process.env.VITE_BASE || "/",
    ...
    define: {
        ...
        // 标识 Electron 构建环境，路由据此切换为 hash 模式以适配 file:// 协议
        __ELECTRON__: JSON.stringify(!!process.env.ELECTRON),
    },
});
